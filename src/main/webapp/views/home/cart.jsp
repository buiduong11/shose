          ...
          <div class="block">
            <div class="product-list">
              <form method="post">
                    ...
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="<%=cart.getImage() %>" alt="" />
                          <a href="#!"><%=cart.getTitle() %></a>
                        </div>
                      </td>
                      <td class="">$<%=cart.getPrice() %></td>
                      <td class=""><%=cart.getQuantity() %></td>
                      <td class="">
                ...
                <a id="checkout" href="/checkout" class="btn btn-main pull-right">Checkout</a>
                <% } %>
              </form>
            </div>
          </div>
        ...
        $.ajax({
            ...
            success: function (result) {
            	...
            	$.each(result, function(index, element) {
            		...
            		tr = '<tr class=""><td class=""><div class="product-info"><img width="80" src="'+element.image+'" alt="" /><a href="#!">'+element.title+'</a></div></td><td class="">$'+element.price+'</td><td class="">'+element.quantity+'</td><td class=""><a id="btn-remove" class="product-remove" onclick="remove('+element.id+')">Remove</a></td></tr>'+tr;
                });
