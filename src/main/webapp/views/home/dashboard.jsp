			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-12 col-sm-4">
					...
					<ul class="top-menu text-right list-inline">
						...
						<li class="dropdown search dropdown-slide"><a href="#!"
							class="dropdown-toggle" data-toggle="dropdown"
							data-hover="dropdown"><i class="tf-ion-ios-search-strong"></i>Login</a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="dashboard-wrapper user-dashboard">
						<div class="media">
							<div class="pull-left">
								<img class="media-object user-img" src="images/avater.jpg"
									alt="Image">
							</div>
							<div class="media-body">
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
									...
									tempore, tempora omnis. Lorem ipsum dolor sit amet, consectetur
									adipisicing elit. Enim, nihil.</p>
							</div>
						</div>
